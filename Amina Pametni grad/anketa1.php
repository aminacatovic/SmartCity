...
if(isset($_SESSION['anketa1'])){
	header("Location: index.php");
}

if(isset($_POST['kraj'])){

	//var_dump($_POST['p1'], $_POST['p2'], $_POST['p3'], $_POST['p4'], $_POST['p5'], $_POST['p7'], $_POST['p8'], $_POST['p9'], $_POST['p10'], $_POST['p11'], $_POST['p12'], 
	//$_POST['p13'], $_POST['p14[]']);
	//die();

	$_SESSION['anketa1'] = array(
		"zavrsena" => 1,
		"poena" => 4
	);

	$sql = "INSERT INTO zavrseni(id, id_user, username, ostvarenopoena, anketa1, anketa2, anketa3, datum) VALUES(DEFAULT, ".$_SESSION['id'].", '".$_SESSION['username']."', 4, ".$_SESSION['anketa1']['zavrsena'].", 0, 0, CURRENT_TIMESTAMP)";
	mysqli_query($db, $sql);

	$sql1 = "INSERT INTO odgovori VALUES(DEFAULT, ".$_SESSION['id'].", '".$_SESSION['username']."', 'anketa1', '".$_POST['p1']."', '".$_POST['p2']."', '".$_POST['p3']."', '".$_POST['p4']."', '".$_POST['p5']."', 
...
<body>
<center><h1>PAMETNO ZDRAVSTVO</h1></center>
